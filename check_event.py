...
def find_index(sel_time, gran, all_time_arr, win_len):
    if gran == 'day':
        _from = datetime.datetime.strptime(sel_time, '%Y-%m-%d %H:%M:%S').strftime('%Y-%m-%d')
        ...
        _from = datetime.datetime.strptime(sel_time, '%Y-%m-%d %H:%M:%S').strftime('%Y-%m-%d %H')
        ...
        _from = datetime.datetime.strptime(sel_time, '%Y-%m-%d %H:%M:%S').strftime('%Y-%m-%d %H:%M')
